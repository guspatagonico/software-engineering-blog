...
const legacyPosts: PostMeta[] = [
  ...
  },
  {
    ...
    description:
      'Análisis de las limitaciones de contexto en LLMs, fundamentos matemáticos y estrategias',
    pubDate: '2026-03-20',
    tags: ['llm', 'context', 'architecture'],
  ...
  {
    id: 'llm-context-limitations-astro',
    title: 'Limitaciones de los LLM en la actualidad (Astro)',
    subtitle: 'Legacy Astro · Ventana de contexto y Smart Context',
    description: 'Version legacy del post, previo a la migracion MDX',
    pubDate: '2026-03-20',
    tags: ['llm', 'context', 'legacy'],
    icon: getPostIcon('llm-context-limitations'),
    ogImage: getPostIcon('llm-context-limitations'),
    iconAlt: 'Limitaciones de los LLM en la actualidad',
    draft: false,
