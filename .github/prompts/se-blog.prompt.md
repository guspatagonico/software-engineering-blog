---
mode: agent
description: Create a long-form software engineering blog post from template
---

Create a new long-form software engineering blog post using `_seed/se-blog-template.astro`.

Requirements:

- Ask for `slug`, `title`, `subtitle`, `description`, `pubDate` (`YYYY-MM-DD`), and `tags`.
